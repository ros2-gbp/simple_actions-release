## simple_actions (rolling) - 0.5.0-1

The packages in the `simple_actions` repository were released into the `rolling` distro by running `/usr/bin/bloom-release simple_actions -r rolling -y` on `Fri, 27 Feb 2026 17:32:22 -0000`
...
## simple_actions (kilted) - 0.5.0-1

The packages in the `simple_actions` repository were released into the `kilted` distro by running `/usr/bin/bloom-release simple_actions -r kilted -y` on `Fri, 27 Feb 2026 17:30:54 -0000`
...
## simple_actions (jazzy) - 0.5.0-1

The packages in the `simple_actions` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release simple_actions -r jazzy -y` on `Fri, 27 Feb 2026 17:20:57 -0000`
...
## simple_actions (humble) - 0.5.0-1

The packages in the `simple_actions` repository were released into the `humble` distro by running `/usr/bin/bloom-release simple_actions -r humble -y` on `Fri, 27 Feb 2026 17:19:10 -0000`
